<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/msr_Navegacion_PL.Master" AutoEventWireup="true" CodeBehind="wfrm_Usuario_Mantenimiento_PL.aspx.cs" Inherits="PL.Paginas.wfrm_Usuario_Mantenimiento_PL" %>
                ...
                <div class="col-md-12">
                    <div class="section-heading">
                        ...
                        <div>
                            ...
                            <button type="submit" id="btn_Atras" class="button" onclick="location.href='wfrm_Usuario_Catalogo_PL.aspx';" style='background: url(../Recursos/Exit.png);'></button>
                        </div>
                    </div>
