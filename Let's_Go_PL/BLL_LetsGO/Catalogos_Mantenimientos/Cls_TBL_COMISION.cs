...
{
   public class Cls_TBL_COMISION

    {    // Metodo para listar los datos
        public void Listar_Comision(ref Cls_TBL_COMISION_DAL Obj_Comision_DAL)
        {
            ...
            try
            {
                ...
                string sNombreSP =  "[SCH_CUENTA].[sp_select_TBL_COMISION]";
