...
{
   public class Cls_TBL_ENCABEZADO
    {
        // Metodo para listar los datos
        public void Listar_Encabezado(ref Cls_TBL_ENCABEZADO_DAL Obj_Encabezado_DAL)
        {
            ...
            try
            {
                ...
                string sNombreSP = "[SCH_CUENTA].[sp_select_TBL_ENCABEZADO]";
