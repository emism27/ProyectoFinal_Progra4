...
{
    public class Cls_TBL_PREGUNTAS_SEGURIDAD_BLL
    {
        public void Listar_Preguntas(ref Cls_TBL_PREGUNTAS_DAL Obj_Preguntas_DAL)
        {
            ...
            try
            {
                ...
                string sNombreSP = "[SCH_CUENTA].[sp_select_TBL_PREGUNTAS]";
