...
{
   public class Cls_TBL_VIAJE
    {
        // Metodo para listar los datos
        public void Listar_Viaje(ref Cls_TBL_VIAJE_DAL Obj_VIAJE_DAL)
        {
            ...
            try
            {
                ...
                string sNombreSP = "[SCH_SERVICIOS].[sp_select_TBL_VIAJE]";
