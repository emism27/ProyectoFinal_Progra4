<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrm_Cuenta_Listar.aspx.cs" Inherits="PL.Paginas.Catalogos_Mantenimientos.wfrm_Cuenta_Listar" %>
        ...
        <div id="datos">
            <asp:GridView ID="dgvDatos" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="True"  GridLines="None" AllowPaging="true" CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Apellido_1" HeaderText="APELLIDO 1" />
                    <asp:BoundField DataField="Apellido_2" HeaderText="APELLIDO 2" />
                    <asp:BoundField DataField="Pass" HeaderText="PASS" />
                    <asp:BoundField DataField="Telefono" HeaderText="TELEFONO" />
                    <asp:BoundField DataField="Email" HeaderText="EMAIL" />
                    <asp:BoundField DataField="ID_Pregunta_Seguridad" HeaderText="PREGUNTA SEGURIDAD" />
                    <asp:BoundField DataField="Respuesta_Seguridad" HeaderText="RESPUESTA SEGURIDAD" />
                </Columns>
            </asp:GridView><br />
        </div>
    </form>
