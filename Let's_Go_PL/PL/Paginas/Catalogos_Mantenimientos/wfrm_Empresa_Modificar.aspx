    ...
    <form runat="server">
        ...
        <div id="formulario">
            <div>
                ...
                <asp:TextBox ID="txt_Id_Empresa" runat="server" placeholder="Ingrese el ID de la Empresa..." CssClass="txt_Texto" requiried="" onkeypress="return validNumeros(event)"></asp:TextBox>
            </div>
            ...
            <div>
                ...
                <asp:TextBox ID="txt_Telefono" runat="server" placeholder="Ingrese el Telefono..." CssClass="txt_Texto" onkeypress="validarNumeroTelefono(evt)"></asp:TextBox>
            </div>
