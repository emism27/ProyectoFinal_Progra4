<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrm_Banco_Listar.aspx.cs" Inherits="PL.Paginas.Catalogos_Mantenimientos.wfrm_Banco_Listar" %>
        ...
        <div id="datos">
            <asp:GridView ID="dgvDatos" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="True"  GridLines="None" AllowPaging="true" CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                ...
                <Columns>
                        ...
                        <asp:BoundField DataField="Nombre_Banco" HeaderText="NOMBRE BANCO" />
                </Columns>
            </asp:GridView><br />
        </div>
    </form>
