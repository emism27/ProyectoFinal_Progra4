<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrm_Rating_Listar.aspx.cs" Inherits="PL.Paginas.Catalogos_Mantenimientos.wfrm_Rating_Listar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div id="datos">
            <asp:GridView ID="dgvDatos" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="True"  GridLines="None" AllowPaging="true" CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                ...
                <Columns>
                    <asp:BoundField DataField="ID_Rating" HeaderText="ID RATING" />
                    <asp:BoundField DataField="Rating" HeaderText="RATING" />
                    <asp:BoundField DataField="ID_Viaje" HeaderText="ID VIAJE" />
                </Columns>
            </asp:GridView><br />
        </div>
    </form>
