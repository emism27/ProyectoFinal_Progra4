    ...
    public partial class wfrm_Tipo_Tarjeta_Listar : System.Web.UI.Page
    {
        ...
        protected void btn_Modificar_Click(object sender, EventArgs e)
        {
            if (dgvTipoTarjeta.Rows.Count > 0)
            {
                ...
                // se llama la pantalla de modificar y se envian los datos
                Response.Redirect("../Modificar/wfrm_Tipo_Tarjeta_Modificar.aspx?id=" + Obj_TIPO_TARJETA_DAL.BID_Tipo_Tarjeta + "&descripcion=" + Obj_TIPO_TARJETA_DAL.SDescripcion + "&axi=" + Obj_TIPO_TARJETA_DAL.CAx);
