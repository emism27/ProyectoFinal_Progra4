            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading">
                        ...
                        <div>
                            <button type="submit" id="btn_Agregar" class="button" onclick="location.href='../Modificar/wfrm_Cliente_Modificar.aspx';" style='background: url(../../../Recursos/Add.png);'></button>
                            <button type="submit" id="btn_Modificar" class="button" onclick="location.href='../Modificar/wfrm_Cliente_Modificar.aspx';" style='background: url(../../../Recursos/Edit.png);'></button>
