                    ...
                    <form id="Vehiculo_Catalogo" method="post">
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div>
                                    <label for="txt_Id_Empresa">ID Empresa: </label><input name="txt_Id_Empresa" type="text" class="form-control" id="txt_Id_Empresa" placeholder="Ingrese el ID de la Empresa..." required=""/>
                                    </div>
                                    ...
                                    <div>
                                    <label for="txt_Direccion">Dirección: </label><input name="txt_Direccion" type="text" class="form-control" id="txt_Direccion" placeholder="Ingrese la Dirección..." required=""/>
                                    </div>

                                    <div>
                                    <label for="txt_Sitio_Web">Sitio Web: </label><input name="txt_Sitio_Web" type="text" class="form-control" id="txt_Sitio_Web" placeholder="Ingrese el Sitio Web..." required=""/>
                                    </div>

                                    <div>
                                    <label for="txt_Telefono">Número de Telefono: </label><input name="txt_Telefono" type="text" class="form-control" id="txt_Telefono" placeholder="Ingrese el Número de Telefono..." required=""/>
                                    </div>
