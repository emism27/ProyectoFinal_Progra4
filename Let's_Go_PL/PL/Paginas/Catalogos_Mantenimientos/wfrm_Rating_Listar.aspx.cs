    ...
    public partial class wfrm_Rating_Listar : System.Web.UI.Page
    {
        ...
        public void CargarDatos()  // metodo para listar los datos
        {
            if (txt_Palabra.Text == string.Empty)
            {
                ...
                Obj_RATING_BLL.Listar_Rating(ref Obj_RATING_DAL);
                ...
                dgvDatos.DataSource = Obj_RATING_DAL.Obj_DT;
                dgvDatos.DataBind();
            }
            else
            {
        ...
        protected void btn_Agregar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("../Catalogos_Mantenimientos/wfrm_Rating_Modificar.aspx?axi=" + Obj_RATING_DAL.CAx);
        }
        ...
        protected void btn_Modificar_Click(object sender, ImageClickEventArgs e)
        {
            if (dgvDatos.Rows.Count > 0)
            {
                ...
                Obj_RATING_DAL.BID_Rating = Convert.ToByte(dgvDatos.SelectedRow.Cells[1].Text);
                Obj_RATING_DAL.BRating = Convert.ToByte(dgvDatos.SelectedRow.Cells[2].Text);
                Obj_RATING_DAL.IID_Viaje = Convert.ToInt32(dgvDatos.SelectedRow.Cells[3].Text);


                Obj_RATING_DAL.CAx = 'U';

                // se llama la pantalla de modificar y se envian los datos
                Response.Redirect("../Catalogos_Mantenimientos/wfrm_Rating_Modificar.aspx?id=" + Obj_RATING_DAL.BID_Rating + "&rating=" + Obj_RATING_DAL.BRating + "&idViaje=" + Obj_RATING_DAL.IID_Viaje + "&axi=" + Obj_RATING_DAL.CAx);
        ...
        protected void btn_Eliminar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (dgvDatos.Rows.Count > 0)
            {
                ...
                Obj_RATING_BLL.Eliminar_Rating(ref Obj_RATING_DAL);
