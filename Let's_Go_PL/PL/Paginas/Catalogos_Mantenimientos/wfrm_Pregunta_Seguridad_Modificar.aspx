    ...
    <form runat="server">
        ...
        <div id="formulario">
            <div>
                ...
                <asp:TextBox ID="txt_Id_Pregunta_Seguridad" runat="server" placeholder="Ingrese el ID de la Pregunta de Seguridad..." CssClass="txt_Texto"></asp:TextBox>
            </div>

            <div>
                <label for="txt_Pregunta">Pregunta: </label>
                <asp:TextBox ID="txt_Pregunta" runat="server" placeholder="Ingrese la Pregunta..." CssClass="txt_Texto"></asp:TextBox>
            </div>
